...
const props = defineProps<{ spinning?: boolean, loginSuccesful?: boolean }>()
...
<template>
  <div
    ...
    <div v-if="!loginSuccesful" class="flex justify-center items-center">
      <div class="text-white text-lg font-normal font-['Arial'] leading-none transition-all">Prijavi se na nalog</div>
      <img
          v-if="spinning"
          class="ml-2 h-4"
          :src="spinner"/>
